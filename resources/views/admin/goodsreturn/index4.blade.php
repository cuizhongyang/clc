            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <!--搜索-->
                  <div class="box-tools">
                    <form action="{{url('admin/goodsreturn/index4')}}" method="get">
                  ...
                  <table class="table table-bordered">
                    ...
                    @foreach($list as $vo) 
                        <tr>
                            ...
                            <td>{{ $vo->addtime }}</td>
                            <td>
                              <button class="btn btn-xs btn-primary" onclick="window.location='{{URL('#')}}/{{ $vo->id }}'">回复卖家</button>
