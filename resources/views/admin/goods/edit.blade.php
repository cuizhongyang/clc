            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-plus"></i> 修改商品信息</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="{{url('admin/edgoods')}}/{{$v->id}}" method="post" id="art_form" class="form-horizontal" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="inputPassword3" value="{{ $v->title }}" placeholder="商品名称" name="title">
                      </div>
                    </div>  
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                      <input type="text"  name="picname" value="{{ $v->picname }}" id="art_thumb">
                        <input type="file" name="file_upload" id="file_upload" value="">
                       <p><img src="{{ asset($v->picname) }}" alt="" id="img1" style="width:100px"></p>
                        <script>
                            $(function () {
...
//                            判断是否有选择上传文件
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4" style="margin-top:7px;">
                        ...
                        <input type="radio"  name="status" {{ ($v->status == 1)?"checked":"" }} value="1" />正在出售  &nbsp; &nbsp;
