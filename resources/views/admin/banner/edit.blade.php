                ...
                <form action="{{url('admin/doit')}}/{{ $k['id'] }}" method="post" enctype="multipart/form-data" id="art_form" class="form-horizontal">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="title" value="{{ $k['title'] }}" class="form-control" id="inputEmail3" placeholder="标题">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                       ...
                       <p><img src="{{env('QINIU_DOMAIN')}}/{{ $k['picname'] }}" alt="" id="img1" style="width:100px"></p>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select name="status" class="form-control">
                            <option value="1" @if($k['status']==1) selected @endif>启用</option>
                            <option value="2" @if($k['status']==2) selected @endif>禁用</option>
                        </select>
                      </div>
                    </div>
