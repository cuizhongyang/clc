            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-plus"></i> 添加基础配置</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="{{url('admin/webconfig')}}" method="post" enctype="multipart/form-data" id="art_form" class="form-horizontal">
                  {{csrf_field()}}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="text" name="logo" id="art_thumb"  value="" >
...
//                            判断是否有选择上传文件
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="recode_number" class="form-control" id="inputEmail3" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="copyright" class="form-control" id="inputEmail3" placeholder="">
                      </div>
                    </div>
