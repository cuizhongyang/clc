				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="{{asset($list->picname)}}" title="pic" />
								</li>
							</ul>
						</div>
					</section>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">{{$list->cpu}}<i></i></li>
															<li class="sku-line">{{$list->size}}<i></i></li>
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">防摔精致包装<i></i></li>
														</ul>
													</div>
													<div class="theme-options">
